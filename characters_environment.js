...
var noseX, noseY, GameStatus;

function startGame() {
  GameStatus = 'start'
  document.getElementById('GameStatus').innerHTML = 'Jogo Carregado! xdxd'
}
...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Pressione o botão jogar para iniciar e jogar", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
